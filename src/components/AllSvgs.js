...
export const LinkedIn = (props) => (
  <svg
    ...
    viewBox="0 0 24 24"
  >
    <path d="M4.98 3.5C4.98 4.88 3.87 6 2.5 6S0 4.88 0 3.5 1.11 1 2.5 1 4.98 2.12 4.98 3.5zM0 24h5V8H0v16zm7.5-16h4.7v2.2h.1c.7-1.3 2.5-2.6 5.1-2.6 5.5 0 6.5 3.6 6.5 8.3V24h-5v-7.7c0-1.8 0-4.2-2.6-4.2-2.6 0-3 2-3 4.1V24h-5V8z" />
  </svg>
);
