...
export const Work = [
  {
    ...
    name: "Coach Website",
    description:
      "React website with a Node.js backend to manage form submissions and data flow.",
  ...
  },
  {
    ...
    description:
      "A mobile coaching app built with React Native for instrcutors. No demo available, use your phone and install expo to see teh results",
  ...
  },
  {
    ...
    description: "A mobile coaching app built with React Native for customers. No demo available, use your phone and install expo to see the results",
  ...
  },
  {
    id: 5,
    name: "Movie library",
    description: "movie library using mongo db. No demo available",
    tags: ["Node.js"],
  ...
  },
  {
    ...
    description: "A quizz using react as frontend and wordpress as backend. No demo available.",
    tags: ["typescript"],
